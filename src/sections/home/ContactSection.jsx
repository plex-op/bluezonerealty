      ...
      <div className="relative z-10 container">
            ...
            >
              ...
              <form onSubmit={handleSubmit} ref={formRef} className="space-y-6">
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500"
                    />
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 resize-none"
                    ></textarea>
                  </div>
                </motion.div>
                ...
                <motion.button
                  ...
                  className="w-full bg-rose-500 text-white px-6 py-4 rounded-lg font-medium text-lg hover:bg-rose-600 shadow-lg flex items-center justify-center space-x-2"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  transition={{ duration: 0.3, delay: 0.5 }}
        ...
        >
          {contactInfo.map((info) => (
            <motion.div
              key={info.id}
              className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl border border-gray-100"
            ...
            >
              <div className="flex flex-col items-center md:flex-row md:items-start gap-4">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  {info.primary && (
                    <p className="text-gray-600 text-sm">{info.primary}</p>
                  )}
                  {info.secondary && (
